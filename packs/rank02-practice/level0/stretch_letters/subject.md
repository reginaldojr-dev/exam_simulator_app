Assignment name  : stretch_letters
Expected files   : stretch_letters.c
...
$> ./stretch_letters alpha beta | cat -e
alpha beta$
$> ./stretch_letters "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./stretch_letters "" tail | cat -e
 tail$
$> ./stretch_letters | cat -e
$
$>
