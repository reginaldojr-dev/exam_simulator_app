Assignment name  : replace_once_set
Expected files   : replace_once_set.c
...
$> ./replace_once_set alpha beta | cat -e
alpha beta$
$> ./replace_once_set "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./replace_once_set "" tail | cat -e
 tail$
$> ./replace_once_set | cat -e
$
$>
