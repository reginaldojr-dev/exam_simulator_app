Assignment name  : copy_until_end
Expected files   : copy_until_end.c
...
$> ./copy_until_end alpha beta | cat -e
alpha beta$
$> ./copy_until_end "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./copy_until_end "" tail | cat -e
 tail$
$> ./copy_until_end | cat -e
$
$>
