Assignment name  : apply_to_nodes
Expected files   : apply_to_nodes.c
...
$> ./apply_to_nodes alpha beta | cat -e
alpha beta$
$> ./apply_to_nodes "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./apply_to_nodes "" tail | cat -e
 tail$
$> ./apply_to_nodes | cat -e
$
$>
