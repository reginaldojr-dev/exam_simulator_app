Assignment name  : remove_matching_nodes
Expected files   : remove_matching_nodes.c
...
$> ./remove_matching_nodes alpha beta | cat -e
alpha beta$
$> ./remove_matching_nodes "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./remove_matching_nodes "" tail | cat -e
 tail$
$> ./remove_matching_nodes | cat -e
$
$>
