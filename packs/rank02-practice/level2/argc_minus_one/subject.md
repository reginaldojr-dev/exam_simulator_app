Assignment name  : argc_minus_one
Expected files   : argc_minus_one.c
...
$> ./argc_minus_one alpha beta | cat -e
alpha beta$
$> ./argc_minus_one "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./argc_minus_one "" tail | cat -e
 tail$
$> ./argc_minus_one | cat -e
$
$>
