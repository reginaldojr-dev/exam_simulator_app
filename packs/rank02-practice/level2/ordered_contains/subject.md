Assignment name  : ordered_contains
Expected files   : ordered_contains.c
...
$> ./ordered_contains alpha beta | cat -e
alpha beta$
$> ./ordered_contains "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./ordered_contains "" tail | cat -e
 tail$
$> ./ordered_contains | cat -e
$
$>
