Assignment name  : triple_space_words
Expected files   : triple_space_words.c
...
$> ./triple_space_words alpha beta | cat -e
alpha beta$
$> ./triple_space_words "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./triple_space_words "" tail | cat -e
 tail$
$> ./triple_space_words | cat -e
$
$>
