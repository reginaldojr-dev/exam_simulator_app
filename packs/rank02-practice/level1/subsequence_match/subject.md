Assignment name  : subsequence_match
Expected files   : subsequence_match.c
...
$> ./subsequence_match alpha beta | cat -e
alpha beta$
$> ./subsequence_match "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./subsequence_match "" tail | cat -e
 tail$
$> ./subsequence_match | cat -e
$
$>
