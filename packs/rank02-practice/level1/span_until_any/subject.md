Assignment name  : span_until_any
Expected files   : span_until_any.c
...
$> ./span_until_any alpha beta | cat -e
alpha beta$
$> ./span_until_any "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./span_until_any "" tail | cat -e
 tail$
$> ./span_until_any | cat -e
$
$>
