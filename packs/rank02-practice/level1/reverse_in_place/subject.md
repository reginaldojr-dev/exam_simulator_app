Assignment name  : reverse_in_place
Expected files   : reverse_in_place.c
...
$> ./reverse_in_place alpha beta | cat -e
alpha beta$
$> ./reverse_in_place "42 Exam" Trainer | cat -e
42 Exam Trainer$
$> ./reverse_in_place "" tail | cat -e
 tail$
$> ./reverse_in_place | cat -e
$
$>
