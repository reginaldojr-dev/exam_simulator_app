...
class DesktopApp:
    def __init__(self) -> None:
        ...
        self._theme_manager = ThemeManager(AppFactory().create_config_repository().load_theme())
    ...
    def _show_startup_window(self) -> None:
        startup_window = StartupWindow(self._workspace_service, self._theme_manager)
